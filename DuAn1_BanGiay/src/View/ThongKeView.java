...
//        showBarChartTop5(new Date(), new Date()); // Hiển thị biểu đồ top 5 mặc định
    ...
    public void showBarChartTop5(Date tuNgayTop5, Date denNgayTop5) {
        ...
        // Lấy tối đa 5 sản phẩm đầu tiên sau khi sắp xếp
        List<Map<String, Object>> top5Sorted = top5SanPham.stream().limit(5).collect(Collectors.toList());

        // Tìm số lượng lớn nhất để điều chỉnh trục Y
        int maxSoLuong = top5Sorted.stream()
                .mapToInt(sanPham -> (Integer) sanPham.get("SoLuong"))
                .max()
                .orElse(0);

        // Điền dữ liệu vào dataset theo thứ tự đã sắp xếp
        for (Map<String, Object> sanPham : top5Sorted) {
    ...
    private void initComponents() {
        ...
        jpn_SanPhamLayout.setHorizontalGroup(
            ...
            .addGroup(jpn_SanPhamLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(dtc_TuTop5, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jLabel7)
                .addGap(32, 32, 32)
                .addComponent(dtc_DenTop5, javax.swing.GroupLayout.PREFERRED_SIZE, 169, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(48, 48, 48)
    ...
    private void btn_TimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_TimActionPerformed
        ...
        calendar.setTime(denNgayTop5);
        calendar.set(Calendar.HOUR_OF_DAY, 23);
        calendar.set(Calendar.MINUTE, 59);
        calendar.set(Calendar.SECOND, 59);
        calendar.set(Calendar.MILLISECOND, 999);
        Date adjustedDenNgayTop5 = calendar.getTime();
        
        showBarChartTop5(tuNgayTop5, adjustedDenNgayTop5);
