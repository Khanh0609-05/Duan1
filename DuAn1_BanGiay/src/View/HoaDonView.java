...
public class HoaDonView extends javax.swing.JFrame {
    ...
    public HoaDonView() {
        ...
        tbl_HoaDon.setAutoCreateRowSorter(false);
    }
    ...
    private String formatCurrency(double amount) {
        ...
        symbols.setGroupingSeparator('.'); // Dùng dấu chấm làm phân cách
    ...
    private void initComponents() {
        ...
        dtc_Den.setMaxSelectableDate(new java.util.Date(253370743305000L));
    ...
    private void btn_TimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_TimKiemActionPerformed
        ...
        // Chuyển đổi dateFrom thành đầu ngày (00:00:00)
        ...
        // Chuyển đổi dateTo thành cuối ngày (23:59:59)
        ...
        // Thêm dữ liệu đã định dạng từ toDataRow() vào bảng
        for (HoaDon hd : listHoaDon) {
            modelHoaDon.addRow(hd.toDataRow()); // Dữ liệu đã được định dạng trong toDataRow()
        }
    ...
    if (danhSachHoaDon != null) {
        // Xóa dữ liệu cũ trong bảng tbl_HoaDon
        javax.swing.table.DefaultTableModel HoaDon = (javax.swing.table.DefaultTableModel) tbl_HoaDon.getModel();
        HoaDon.setRowCount(0);

        // Thêm dữ liệu mới vào bảng tbl_HoaDon
        for (HoaDon hd : danhSachHoaDon) {
            HoaDon.addRow(hd.toDataRow()); // Dữ liệu đã được định dạng trong toDataRow()
        }
        ...
        // Reset ngày tìm kiếm
        dtc_Tu.setDate(null);
        dtc_Den.setDate(null);

        // Reset bảng chi tiết hóa đơn (tbl_HoaDonCT)
    ...
    private void txt_TimKiemKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_TimKiemKeyReleased
        ...
        if (searchText.isEmpty()) {
            listHD = repoHD.lamMoi(); // Lấy toàn bộ danh sách hóa đơn
        } else {
            listHD = repoHD.timHDKhongTheoNgay(searchText); // Tìm kiếm theo từ khóa
        }
        ...
        for (HoaDon hd : listHD) {
            model.addRow(hd.toDataRow()); // Dữ liệu đã được định dạng trong toDataRow()
